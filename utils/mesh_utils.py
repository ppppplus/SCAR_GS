...
def post_process_mesh(mesh, cluster_to_keep=1):
    ...
    # print(mesh_0 is None)
    print(f"# triangles: {len(mesh_0.triangles)}")
    print(f"# vertices: {len(mesh_0.vertices)}")
    ...
    if cluster_n_triangles.size == 0:
      print("[Warning] No connected triangle clusters found in mesh.")
      mesh = o3d.geometry.TriangleMesh()
      mesh.vertices = o3d.utility.Vector3dVector(np.array([[0.0, 0.0, 0.0]]))
      return mesh  # 或者其他合理的默认行为
    else:
