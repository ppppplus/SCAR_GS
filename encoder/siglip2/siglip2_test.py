...
def main(img_path, query_text, feature_extractor, mask_generator, feature_compressor, resize_if_taller_than=1080):
    ...
    # enc_feats /= enc_feats.norm(dim=-1, keepdim=True)
    # print(enc_feats.norm(dim=-1, keepdim=True))
    # prob_map2 = text_image_match_heatmap(seg_map, enc_feats, text_feat, feature_extractor)
    # plot_heatmap(prob_map2, image=img_bgr)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Training script parameters")
    parser.add_argument('--image_path', type=str, default="/home/ubuntu/TJH/Work/aff_ws/LEGaussians/my_scripts/data/0000.png")
    parser.add_argument('--ckpt_path', type=str, default="siglip2_sam05_0000_128_768_1_20251014-153454_codebook.pt")
    ...
    img_folder = "/home/ubuntu/TJH/Work/aff_ws/LEGaussians/datasets/omni/kitchen/images"
    ...
    if args.type == "ae":
        feature_compressor = VectorAE(args.f_dim, args.e_dim, device)
    ...
    # missing, unexpected = feature_compressor.load_state_dict(sd["model_state"], strict=True)
    # print("missing:", missing, "unexpected:", unexpected)
    # feature_compressor.to(device).eval() 
    main(args.image_path, args.query, feature_extractor, mask_generator, feature_compressor)
