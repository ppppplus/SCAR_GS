...
class SamDeticFeatureExtractor:
    def __init__(self, args):
        ...
        # --- Detic part ---
        self.detic_extractor = DeticFeatureExtractor()
        # --- featcomp part ---
        ...
        self.start_out_dir = os.path.join(self.start_dir, "samdetic_embeddings")
        self.end_out_dir = os.path.join(self.end_dir, "samdetic_embeddings")
...
if __name__ == "__main__":
    ...
    samdetic_extractor = SamDeticFeatureExtractor(args)
    samdetic_extractor.process_dataset()