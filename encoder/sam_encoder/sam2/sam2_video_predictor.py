...
from sam2.utils.misc import concat_points, fill_holes_in_mask_scores, load_video_frames, load_video_frames_from_paths
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def init_state_from_frames(
        ...
        """Initialize an inference state directly from a list of frame paths."""
        compute_device = self.device  # device of the model

        # ✅ 这里替换 load_video_frames，用已有的函数 load_video_frames_from_paths
        images, video_height, video_width = load_video_frames_from_paths(
